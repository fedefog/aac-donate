                ...
                <div class="col-xs-12 col-md-6">
                    <div class="container-settings">
                        <div class="box-settings">
                            ...
                            <input type="checkbox" class="switch-settings" id="my-checkbox" value="1" id="my-checkbox" name="my-checkbox" <?php if ($user_data['ShowUserDisplayName'] == "1") echo "checked"; ?>>
                        </div><!-- /box-settings -->
                    ...
                    <div class="container-settings">
                        <div class="box-settings">
                            ...
                            <input type="checkbox" class="switch-settings" id="checkbox-automatic-login" value="1" id="my-checkbox1" name="my-checkbox1" <?php if ($user_data['AutomaticLogin'] == "1") echo "checked"; ?>>
                        </div><!-- /box-settings -->
                    ...
                    <div class="container-settings">
                        <div class="box-settings">
                            ...
                            <input type="checkbox" class="switch-settings" id="chebox-sms" id="my-checkbox2" name="my-checkbox2" value="1" <?php if ($user_data['Sms_enabled'] == "1") echo "checked"; ?> >
                        </div><!-- /box-settings -->
                        <div class="container-settings-msj" style="display: <?php if ($user_data['Sms_enabled'] == "1") echo "block"; ?>;">
                            <div class="box-settings box-settings-msj">
                                ...
                                <input type="checkbox" class="switch-settings" value="1" id="my-checkbox3" name="my-checkbox3">
                            </div><!-- /box-settings -->
                            <div class="box-settings box-settings-msj">
                                <div class="box-settings-info">
                                    <h2 class="title-settings title-send">Send SMS when </h2>
                                ...
                                <input type="checkbox" class="switch-settings" value="1" id="my-checkbox4" name="my-checkbox4" >
                            </div><!-- /box-settings -->
                            <div class="box-settings box-settings-msj">
                                <div class="box-settings-info">
                                    <h2 class="title-settings title-send">Send SMS when </h2>
                                ...
                                <input type="checkbox" class="switch-settings" value="1" name="my-checkbox5" >
                            </div><!-- /box-settings -->
                                ...
                                <form class="form-phone-number">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="txtPhone" name="txtPhone" class="form-control phone-number-input" value="<?php echo $user_data['Mobile']; ?>">
                                        </div><!-- /input-group -->
                                    </div><!-- /form-group -->
                                </form>
                            </div>
                    ...
                    <div class="container-settings">
                        ...
                        <div class="container-password-settings">
                            <div class="box-settings-password">
                                ...
                                <input id="txtOldPwd" id="txtOldPwd" name="txtOldPwd" type="password" class="form-control" placeholder="Enter current password">
                            ...
                            <div class="box-settings-password">
                                ...
                                <input type="password" id="txtNewPwd" name="txtNewPwd" class="form-control" placeholder="Choose new password">
                            </div><!-- /box-settings-password -->
                            <div class="box-settings-password">
                                <h2 class="title-password-settings">VERIFY PASSWORD</h2>
                                <input type="password" id="txtCfmPwd" name="txtCfmPwd" class="form-control" placeholder="Confirm new password">
                            </div><!-- /box-settings-password -->
                        </div>
