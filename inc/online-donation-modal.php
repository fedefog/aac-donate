<div class="modal-online-donation modal-gral modal fade" id="modal-online-donation" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-content">
		...
		<div class="modal-body">
			...
			<div class="row-modal ">
				...
				<h2 class="title-modal">ONLINE DONATION</h2>
