	...
	<form class="invite-friend">
		...
		<div class="container">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control input-text" placeholder="Enter your friend’s name" >
			...
			<div class="form-group">
				...
				<input type="text" class="form-control input-text " placeholder="Enter your friend’s email address" >
			...
			<div class="form-group">
				...
				<textarea cols="30" rows="10" class="comment-textarea " placeholder="Enter any text that you'd like to pass on"></textarea>
			
			</div><!-- /form-group -->

			<a href="#" class="send-invite">Send Invite</a>
