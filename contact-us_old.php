...
if ($_POST['doAction']) {
    ...
    if ($_POST['message'] && $_POST['name']) {
        echo "Here.. IF";
        $fields['email'] = 'website@achisomoch.org';
        $fields['name'] = $_POST['name'];
        $subject = 'Achisomoch - members page';
        $body = 'The following message has been sent via the Achisomoch website: ' . "\n\n";
        $body .= "Name:{$fields['name']}\n";
        $body .= "Username:{$fields['Username']}\n";
        $body .= "Reference:{$fields['Reference']}\n";
        $body .= "{$fields['Username']} said:\n\n";
        $body .= $_POST['message'];
        echo EMAIL_ADMIN_CONTACT;
        echo "<br/>";
        echo $subject;
        echo "<br/>";
        echo $body;
        ...
        echo EMAIL_ADMIN_CONTACT;
        exit;
        //echo mail(EMAIL_ADMIN_CONTACT, $subject, $body, $fields['email']);
        //mail(EMAIL_ADMIN_CONTACT, $subject, $body, "From:{$fields['email']}\r\n");
        //header('location:contact-us.php?done=true');
        exit;
    } else {
        echo "Here.. Else";
