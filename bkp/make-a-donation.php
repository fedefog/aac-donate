			...
			<div class="row">
				<div class="col-md-6 col-xs-12 border-right padding-right">
					...
					<div class="box-make-donation">
						...
						<input type="text" class="form-control confirmation-amount input-text" placeholder="Please re-enter the amount you wish to donate">
					...
					<div class="box-make-donation visible-xs">
					...
					<div class="box-make-donation standing-order-switch-container hidden-xs">
						
						<div class="half-make-donation">
							
							<h2 class="title-make-donation">STANDING ORDER</h2>
						
							<input type="checkbox" class="standing-order-switch" name="my-checkbox">
